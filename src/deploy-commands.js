...
// 	.then((data) => log(`Successfully registered ${data.length} application commands to PARFAIT DIRT.`))
// 	.catch(console.error);

// deploy commands GLOBALLY
rest.put(Discord.Routes.applicationCommands(process.env.CLIENT_ID), {body: commands})
	.then((data) => log(`Successfully registered ${data.length} application commands GLOBALLY.`))
	.catch(console.error);
