...
const {getCriteria, parseSuccessesString, parseCritSuccessString, parseCritFailureString, skillCheck, SKILL_CHECK_RESULTS} = require('../utility-functions/trinity-functions.js')
...
module.exports = {
    ...
    .addBooleanOption(option =>
      option.setName('skip150')
        .setDescription('skip rolling dice corresponding to magnitude above 150, opting instead for an automatic success')
        .setRequired(false)
    )
    .addIntegerOption(option =>
      option.setName('auto-successes')
    ...
    log(`received parameters: {repetitions: ${numberOfBatchRolls}, rank: ${rank}, magnitude: ${magnitude}, autoSuccesses: ${autoSuccesses}, skip150: ${skip150}}`)
